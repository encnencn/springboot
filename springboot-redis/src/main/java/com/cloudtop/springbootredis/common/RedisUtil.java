...
public class RedisUtil {
     ...
     * @param item 项
     * @param value 值
     * @param time 时间秒 如果已存在hash表有时间，这里会替换原有时间
     ...
     *
     * @param key 键
     * @param index 索引 index>=0时， 0 表头 1 第一个元素 依次类推
     *              index<0时，-1 表尾， -2 表尾第二个元素
     * @return
     */
